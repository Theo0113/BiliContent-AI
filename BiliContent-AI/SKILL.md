---
name: "BiliContent AI"
description: "B站内容智能提取与AI知识精炼。从B站视频/合集/UP主空间提取AI字幕，输出5种格式，并通过AI加工为排版字幕和结构化文章。"
---

# BiliContent AI — B站内容智能提取与知识精炼

从B站视频中提取AI字幕，通过AI加工为结构化知识，实现视频内容到文本知识的高效转化。

## 能力全景

| 能力 | 说明 |
|------|------|
| **内容源识别** | 支持单视频 / 合集 / UP主空间三种来源，统一输出 |
| **字幕提取** | 分批获取B站AI字幕，内置质量修复，输出5种格式 |
